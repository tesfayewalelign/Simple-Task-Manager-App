...
export default function SignupForm() {
  ...
  return (
    <div
      className="
        flex justify-center items-center min-h-screen w-screen
      ...
      >
        ...
        <div
          className="
            ...
            w-full md:w-auto md:max-w-[420px] /* allow auto width and max */
            p-8 md:p-12
            gap-5
          "
        >
          ...
          <div className="flex flex-col gap-4 w-full max-w-full">
            <Input
              className="w-full px-4 py-3 bg-[#f9f9f9] rounded-lg border border-[#d1d1d1]"
              placeholder="Name"
              type="text"
            />
            <Input
